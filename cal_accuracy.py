...
【图像信息】
<img>/media/oem/12T/HZY/HTH/data/picture/{}</img>
...
for large_img_path in large_imgs:
    ground_truth = find_columns_with_value_one('test/label_house.csv', large_img_path) + find_columns_with_value_one(
        'test/label_tree.csv', large_img_path) + find_columns_with_value_one('test/label_human.csv', large_img_path)
    if ground_truth:
